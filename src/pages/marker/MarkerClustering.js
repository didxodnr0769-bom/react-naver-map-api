...
// 출처 : https://github.com/navermaps/marker-tools.js/blob/master/marker-clustering/src/MarkerClustering.js
...
// naver.maps에 MarkerClustering 등록
if (typeof window !== "undefined" && window.naver && window.naver.maps) {
  window.naver.maps.MarkerClustering = MarkerClustering;
}

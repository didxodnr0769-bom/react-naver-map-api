...
네이버 지도 API를 사용한 지도 컨트롤 예제입니다. 이 예제는 다음과 같은 기능들을 제공합니다:

- **줌 레벨 변경**: 줌 인/아웃, 특정 줌 레벨로 설정
- **위치 이동**: 서울, 부산, 제주 등 특정 위치로 지도 중심 이동
- **지도 유형 변경**: 일반, 위성, 하이브리드, 지형 지도로 전환
- **실시간 줌 레벨 표시**: 현재 줌 레벨을 실시간으로 표시
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    ...
    <div className="control-section">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button onClick={() => setZoomLevel(10)}>줌 10</button>
        <button onClick={() => setZoomLevel(15)}>줌 15</button>
        <button onClick={() => setZoomLevel(20)}>줌 20</button>
      </div>
    ...
    <div className="control-section">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button onClick={moveToJeju}>제주로 이동</button>
      </div>
    </div>
    ...
    <div className="control-section">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button onClick={() => changeMapType("hybrid")}>하이브리드</button>
        <button onClick={() => changeMapType("terrain")}>지형</button>
      </div>
      <p>현재 지도 유형: {mapType}</p>
    </div>
  </div>
</div>;
